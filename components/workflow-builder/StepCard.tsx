...
const CHOICE_TYPES: StepTypeValue[] = [
  "single_select",
  "multi_select",
];
...
export function StepCard({
  ...
  function updateValidationRules(
    patch: Partial<StepValidationRules>
  ) {
    onUpdate(index, {
      validation_rules: {
    ...
    <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="space-y-4">
        ...
        {isFileType && (
          <FileConfigFields
            acceptedTypes={
              step.validation_rules?.accepted_types
            }
            maxSizeBytes={
              step.validation_rules?.max_size_bytes
            }
